...
for wine_type in wine_types:
    ...
    print(f"\nWpływ cech na ocenę wina {wine_names[wine_type]} (tylko 5% najwyżej ocenianych):")

    # Wyodrębnienie top 5% najlepiej ocenianych win ze zbioru testowego
    threshold_quality = np.percentile(y_test_type, 95)
    top_5_mask = y_test_type >= threshold_quality

    X_test_top_5 = X_test_type[top_5_mask]
    y_test_top_5 = y_test_type[top_5_mask]

    print(f"Próg punktacji dla 5% najlepszych win: {threshold_quality}. Liczba obserwacji: {len(y_test_top_5)}")
...
print("\nPORÓWNANIE WAŻNOŚCI CECH DLA TOP 5% WIN")
